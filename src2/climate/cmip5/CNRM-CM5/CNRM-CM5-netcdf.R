setwd("~/Open Modeling Group Dropbox/COACCH/climate/cmip5/CNRM-CM5/rcp85/")
...
files = grep("200601|205601", filenames, value = TRUE)  #only for historical data
files = sort(files)
...
ncnew <- nc_create( "../ts-CNRM-CM5-rcp85.nc", ts ) 
